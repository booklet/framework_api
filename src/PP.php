...
class PP
{
    public static function print($variable, $strlen = 1000, $width = 100, $depth = 100, $i = 0, &$objects = [], $backtrace = false)
    {
          ...
          case 'array':
            ...
            elseif(!$len) $string.= 'array(0) {}';
              ...
              foreach($keys as $key) {
                ...
                $string.= "\n".$spaces."  [$key] => ";
                $string.= self::print($variable[$key],$strlen,$width,$depth,$i+1,$objects);
                $count++;
              }
              $string.="\n".$spaces.'}';
            }
          ...
          case 'object':
            ...
            if ($id!==false)
              ...
              foreach($properties as $property) {
                ...
                $string.= "\n".$spaces."  [$name] => ";
                $string.= self::print($array[$property],$strlen,$width,$depth,$i+1,$objects);
              }
              $string.= "\n".$spaces.'}';
            }
            break;
